...
Top.ZIndex = 2
	...
	Logo.Image = "rbxassetid://13486422974"
	Logo.Active = true
	Logo.ZIndex = 8
	...
	Name.Text = "NIGHT HUB | Blox Fruits"
...
ImageButton1.Image = "https://www.roblox.com/library/14525935929/logo"
...
--// Fast Attack
local AttackList = {"Slow", "Default", "Fast", "Super Fast"}
...
Main:Toggle('Bypass Tp[BETA]', BypassTP, function(vale)
  BypassTP = vale
end)
...
Main:Toggle("Auto Farm Chest (Tween)[BETA]",false,function(t)
...
Shop:Button("Random Race (Use 3K Fragments)", function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("NIGHT HUB | Blox Fruits") then
            game.CoreGui:FindFirstChild("NIGHT HUB | Blox Fruits"):Destroy()
            game.CoreGui:FindFirstChild("NIGHT HUB FOR PC AND MOBILE"):Destroy()
        end
    end)
